...
<head>
  ...
  <link rel="icon" href="http://anc.bzh/wp-content/uploads/2019/07/cropped-logoSimple-e1562314475883-32x32.png" sizes="32x32" />
  ...
  <link href="page_type/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Lato:400,700,400italic,700italic" rel="stylesheet" type="text/css">

  <!-- Theme CSS -->
  <link href="styles/style_rb.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        <img src="http://anc.bzh/wp-content/uploads/2019/07/Logo.png" alt="ANC" id="logo" data-height-percentage="75" />
      </a>
            ...
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <?php require('./php/formulaire2.php'); ?>
  ...
  <footer class="footer text-center">
    <div class="container">
      <div class="row">
        ...
        <!-- Footer IOC Text -->
        <div class="col-lg-4">
          <h4 class="text-uppercase mb-4">ANC Conteneur</h4>
  ...
  <script src="page_type/vendor/jquery/jquery.min.js"></script>
  <script src="page_type/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Plugin JavaScript -->
  <script src="page_type/vendor/jquery-easing/jquery.easing.min.js"></script>
